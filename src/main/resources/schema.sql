...
/* 口座マスタ作成 */
CREATE TABLE IF NOT EXISTS bank_account_mst (
...
/* お手伝いマスタ作成 */
CREATE TABLE IF NOT EXISTS help_mst (
...
/* ユーザーお手伝いリスト作成 */
CREATE TABLE IF NOT EXISTS user_help_list (
...
/* 報告されたお手伝いリスト作成 */
CREATE TABLE IF NOT EXISTS reported_help_list (
...
/* 承認したお手伝いリスト作成 */
CREATE TABLE IF NOT EXISTS approved_help_list (
...
/* 差戻しお手伝いリスト作成 */
CREATE TABLE IF NOT EXISTS not_approved_help_list (
...
/* ユーザーイメージマスタ作成 */
CREATE TABLE IF NOT EXISTS user_image_mst (
...
/* プロフィールマスタ作成 */
CREATE TABLE IF NOT EXISTS profile_mst (
